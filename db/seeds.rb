...
# Mexican Restaurants
path_image = 'app/assets/images/restaurants/1.jpeg'
r = Restaurant.create!(
  name: 'Los Sombreros',
...
prod.image.attach(io: File.open('app/assets/images/products/nachosg.jpg'), filename: 'nachosg.jpg')
prod = Product.create!(name: 'Nacho', price: 19, description: 'Tortilhas com milho', product_category: pc)
prod.image.attach(io: File.open('app/assets/images/products/nachosg2.jpeg'), filename: 'nachosg2.jpeg')

path_image = 'app/assets/images/restaurants/2.jpeg'
r = Restaurant.create!(
  name: 'Ola Que Tal',
...
prod.image.attach(io: File.open('app/assets/images/products/bt.jpg'), filename: 'bt.jpg')
prod = Product.create!(name: 'Quesadilha', price: 25, description: 'Tortilhas de queijo',  product_category: pc)
prod.image.attach(io: File.open('app/assets/images/products/quesa.jpeg'), filename: 'quesa.jpeg')

# Italian Restaurants
path_image = 'app/assets/images/restaurants/3.jpeg'
r = Restaurant.create!(
  name: 'Bravo',
...
prod.image.attach(io: File.open('app/assets/images/products/berinjela.jpg'), filename: 'berinjela.jpg')
prod = Product.create!(name: 'Fritas', price: 35, description: 'Bata frita com bacon',  product_category: pc)
prod.image.attach(io: File.open('app/assets/images/products/fritas.jpg'), filename: 'fritas.jpg')

path_image = 'app/assets/images/restaurants/4.jpeg'
r = Restaurant.create!(
  name: 'La Pergoletti',
...
prod.image.attach(io: File.open('app/assets/images/products/fogazza.jpg'), filename: 'fogazza.jpg')
...
path_image = 'app/assets/images/restaurants/5.jpeg'
r = Restaurant.create!(
  name: 'Sushi Eterno',
...
prod.image.attach(io: File.open('app/assets/images/products/temaki.jpeg'), filename: 'temaki.jpeg')
prod = Product.create!(name: 'Sashimi', price: 30.90, description: 'Peixe cru fatiado, salmao, atum e peixe prego',  product_category: pc)
prod.image.attach(io: File.open('app/assets/images/products/sashimi.jpg'), filename: 'sashimi.jpg')

path_image = 'app/assets/images/restaurants/6.jpeg'
r = Restaurant.create!(
  name: 'Okuyamah',
...
prod.image.attach(io: File.open('app/assets/images/products/hosomaki.jpg'), filename: 'hosomaki.jpg')
prod = Product.create!(name: 'Hot roll - 10 unidades', price: 12, description: '10 unidades.',  product_category: pc)
prod.image.attach(io: File.open('app/assets/images/products/hot-holl.jpg'), filename: 'hot-holl.jpg')

# Vegan Restaurants
path_image = 'app/assets/images/restaurants/7.jpeg'
r = Restaurant.create!(
  name: 'Club Life',
...
prod.image.attach(io: File.open('app/assets/images/products/coleslaw.jpg'), filename: 'coleslaw.jpg')
...
prod.image.attach(io: File.open('app/assets/images/products/side-salad.jpeg'), filename: 'side-salad.jpeg')

path_image = 'app/assets/images/restaurants/8.jpeg'
r = Restaurant.create!(
  name: 'Casa Natural',
...
prod.image.attach(io: File.open('app/assets/images/products/salada-de-quinoa.jpg'), filename: 'salada-de-quinoa.jpg')
...
prod.image.attach(io: File.open('app/assets/images/products/coleslaw2.jpeg'), filename: 'coleslaw2.jpeg')
